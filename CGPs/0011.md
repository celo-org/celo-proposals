...
With a block gas limit of 17M and an equal constant load of 17M, the testnet was running for 6 hours and 45, with an average block time of 6.48 seconds. There were not any major stall of the network and the only issue observer was some epoch block duration of around 2 minutes.

After reducing the block gas limit to 13M and a constant block gas consumption very close to 13M, the testnet was running for 10 hours, with not major issue observed, and average block time of 5.6 seconds and most of the epoch block duration around 2 minutes. We can explain the deviation from the 5 seconds block time due to the block duration for epoch and epoch+1 blocks.

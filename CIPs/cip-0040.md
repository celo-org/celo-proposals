...
domains will maintain some amount of state (e.g. number of queries made against a domain) in a
...
options. Note that the valid options for the quota status request MAY be different than valid
...
options. Note that the valid options for the disabled domain request MAY be different than valid
options for the signature request.

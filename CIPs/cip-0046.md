...
For transparency, an exchanger is encouraged to provide answers to all the provided questions. If the exchanger does not wish to provide certain information, they should explain why. For ease of use, a template for the forum post is provided [here](https://forum.celo.org/t/template-granda-mento-exchange-proposal-discussion/1282).

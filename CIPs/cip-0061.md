...
As the information of the `baseFee` is not in the state anymore, checking that a change was performed, has being simplified (`Header(N).baseFeePerGas != Header(N-1).baseFeePerGas`).
...
Contract:
* https://github.com/celo-org/celo-monorepo/pull/10379

Client:
* https://github.com/celo-org/celo-blockchain/pull/2128 
* https://github.com/celo-org/celo-blockchain/pull/2158

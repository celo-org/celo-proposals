...
author: Amy Slawson <amy@clabs.co>, Cody Born <cody@clabs.co>, Victor Graf <victor@celo.org>, Zviad Metreveli
...
mapping(address => uint64) public attestationRequestCount;
mapping(address => uint64) public attestationCompletionCount;

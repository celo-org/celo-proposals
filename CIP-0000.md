...
Building consensus with the Celo community must adhere to the [Celo Code of Conduct](https://celo.org/code-of-conduct) and the [Celo Community Tenets](https://celo.org/community). Your CIP must also be in-line with Celo’s Community Tenets. For example, proposals like changing consensus mechanisms to Proof-of-Work doesn’t follow Celo’s vision because it won’t make Celo accessible to everyone with a smartphone and will therefore not help advance Celo.

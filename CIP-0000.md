...
For Ring 0-1 CIPs, given that they require Celo’s client implementation to be considered **Final** (see “CIPs Process” below), the CIP author will need to either provide an implementation for the celo-blockchain client or convince clients to implement your CIP.
